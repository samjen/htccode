...
if ( function_exists( 'add_image_size' ) ) { 
	add_image_size( 'product-thumb', 357, 357, true ); //(cropped)
	add_image_size( 'homepage-thumb', 180, 100, true ); //(cropped)
}
...
class Child_Wrap extends Walker_Nav_Menu
{
    function start_lvl(&$output, $depth)
    {
        ...
        $output .= "\n$indent<div style=\"display: none; opacity: 1;left:80px;\" class=\"megapanel\" id=\"mega4width\"><ul class=\"row\" id=\"rowstyl\">\n";
    }
